  ...
  data:         [
    {
      ...
      links: {
        remove: 'https://yonasb29head.qa.rancher.space/v1/autoscaling.horizontalpodautoscalers/cattle-system/test',
        self:   'https://yonasb29head.qa.rancher.space/v1/autoscaling.horizontalpodautoscalers/cattle-system/test',
        update: 'https://yonasb29head.qa.rancher.space/v1/autoscaling.horizontalpodautoscalers/cattle-system/test',
        view:   'https://yonasb29head.qa.rancher.space/apis/autoscaling/v2/namespaces/cattle-system/horizontalpodautoscalers/test'
      },
      ...
      metadata:   {
        ...
        state:             {
          error:         true,
          message:       'the HPA was unable to compute the replica count: failed to get cpu utilization: missing request for cpu in container rancher of Pod rancher-6f5f99c7db-f8f86',
          name:          'pending',
          transitioning: false
        },
      ...
      status: {
        conditions: [{
          error:              false,
          lastTransitionTime: '2024-07-04T19:15:39Z',
          lastUpdateTime:     '2024-07-04T19:15:39Z',
